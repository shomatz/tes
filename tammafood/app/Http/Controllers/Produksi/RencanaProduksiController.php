...
class RencanaProduksiController extends Controller
{
  ...
  public function produksi(){
    $pp = DB::Table('m_item')
          ->join('d_productplan','m_item.i_id','=','d_productplan.pp_item')->get();
    
    return view('produksi.rencanaproduksi.produksi', compact('pp'));
  }
  ...
  public function setData($pp){
    ...
    foreach ($data as $key) {
      ...
      $data[$i]['pp_date']=Date('d-m-Y', strtotime($key['pp_date']));
      $i++;
    }
