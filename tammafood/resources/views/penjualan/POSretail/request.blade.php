              ...
              <div class="modal-dialog">
                ...
                <div class="modal-body">
                                ...
                                <div class="col-md-8 col-sm-9 col-xs-12">
                                  <div class="form-group">
                                    <div class="input-icon right">
                                      ...
                                      <input type="hidden" id="" readonly="true" name="ri_admin" class="form-control input-sm" value="{{ Auth::user()->id }}">      
                                    </div>                           
                                  </div>
                                </div>
                                <div class="col-md-4 col-sm-3 col-xs-12">
                  ...
                  <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" type="button" onclick="detail_request_save()">Proses</button> 
                  </div>
              </div>
